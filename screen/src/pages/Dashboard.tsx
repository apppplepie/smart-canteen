...
// --- Mock Data ---
const initialWindows = Array.from({ length: 20 }, (_, i) => {
...
const CallingArea = () => {
  const [justServed, setJustServed] = useState<{id: string, win: string}[]>([
    { id: 'A042', win: 'W02' },
    { id: 'B105', win: 'W05' }
  ]);
  const [waiting, setWaiting] = useState<string[]>(['A038', 'A039', 'B101', 'C022', 'A040', 'B102', 'C023']);
